      ...
      <div className="container py-12">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-400">
              <li>
                <a href={`tel:${CONTACT_PHONE_E164}`} className="transition hover:text-white">
                  {CONTACT_PHONE_DISPLAY}
                </a>
              </li>
              <li>
                <a href={`mailto:${CONTACT_EMAIL}`} className="break-all transition hover:text-white">
                  {CONTACT_EMAIL}
                </a>
              </li>
              <li className="leading-7">{CONTACT_ADDRESS}</li>
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold">Redes e CTA</h3>
            <div className="mt-4 flex gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 text-gray-300 transition hover:bg-primary-700 hover:text-white"
              >
