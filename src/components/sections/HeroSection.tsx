            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              >
                Agendar Consulta
                            ...
                            <a                 href="https://wa.me/5562996290052"                 target="_blank"                 rel="noopener noreferrer"                className="btn bg-white border border-gray-300 px-8 py-3 text-lg text-gray-700 hover:bg-gray-50 inline-flex items-center justify-center"              >
