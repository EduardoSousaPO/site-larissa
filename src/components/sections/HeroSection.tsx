        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.1fr,0.9fr]">
          ...
          >
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-primary-200">
              Psicoterapia para mulheres que querem relações mais leves
            </p>
            <h1 className="max-w-3xl text-4xl font-bold leading-tight text-white md:text-5xl lg:text-6xl">
              Um espaço acolhedor para você sair do apego ansioso e viver o amor com mais leveza.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-primary-200 lg:mx-0">
              Com o <strong className="font-semibold text-white">Método S.E.R. — Segurança Emocional Reconstruída</strong>,
              você aprende a se regular, confiar em si mesma e construir vínculos seguros — no seu tempo, sem cobrança.
            </p>
            ...
            <p className="mt-4 text-sm text-primary-100/80">
              Primeira conversa leve, no seu ritmo. Um espaço seguro para você respirar e ser ouvida.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="mt-8 rounded-[1.75rem] border border-white/10 bg-white/10 p-6 text-center shadow-xl backdrop-blur-xl md:text-left">
              ...
              <ul className="mt-3 space-y-2 text-sm leading-7 text-white/85">
                <li>respirar sem sentir que precisa dar conta de tudo</li>
                <li>entender seus gatilhos sem se julgar</li>
                <li>se reconectar com a própria segurança interna</li>
                <li>amar sem medo de ser demais ou de menos</li>
              </ul>
            </div>
          </motion.div>
        </div>
