...
import { createWhatsAppProps, getCurrentPath } from '../lib/whatsapp';
...
const WhatsAppFloat = () => {
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-lg bg-gray-900 px-3 py-2 text-sm text-white opacity-0 transition-opacity group-hover:opacity-100">
        Fale com a Dra. Larissa
      </span>
    </motion.a>
  );
};
